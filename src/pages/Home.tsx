    ...
    <>
      ...
      <section className="relative py-20 bg-gradient-to-br from-amber-500 via-amber-600 to-amber-700 overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-lg sm:text-xl text-amber-100 mb-8 sm:mb-10 max-w-2xl mx-auto leading-relaxed animate-fade-in-up-delay-1">
          ...
          <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 justify-center animate-fade-in-up-delay-2">
            <a
              href="/contact"
              className="group relative bg-white text-amber-600 px-6 sm:px-8 md:px-10 py-3 sm:py-4 rounded-xl font-semibold text-base sm:text-lg shadow-2xl hover:shadow-white/25 transition-all duration-500 transform hover:-translate-y-2 hover:scale-105 overflow-hidden w-full sm:w-auto text-center"
            >
            ...
            <a
              href="/portfolio"
              className="group relative border-2 border-white text-white px-6 sm:px-8 md:px-10 py-3 sm:py-4 rounded-xl font-semibold text-base sm:text-lg hover:bg-white hover:text-amber-600 transition-all duration-500 transform hover:-translate-y-1 hover:scale-105 backdrop-blur-sm bg-white/10 shadow-lg hover:shadow-xl overflow-hidden w-full sm:w-auto text-center"
            >
